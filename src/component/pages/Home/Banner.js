...
const Banner = () => {
    return (
        <div>
            <div className="carousel w-screen h-5/6 mb-0">
                <div id="slide1" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-2/4">
                        <a href="#slide4" className="btn btn-xs  mr-5">PREV</a>
                        <a href="#slide2" className="btn btn-  mr-5">NEXT</a>
                    </div>
                </div>
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-2/4">
                        <a href="#slide1" className="btn btn-circle  mr-5">PREV</a>
                        <a href="#slide3" className="btn btn-circle  mr-5">NEXT</a>
                    </div>
                </div>
                <div id="slide3" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-2/4">
                        <a href="#slide2" className="btn btn-circle  mr-5">PREV</a>
                        <a href="#slide4" className="btn btn-circle  mr-5">NEXT</a>
                    </div>
                </div>
                <div id="slide4" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-2/4">
                        <a href="#slide3" className="btn btn-circle  mr-5">PREV</a>
                        <a href="#slide1" className="btn btn-circle  mr-5">NEXT</a>
                    </div>
                </div>
            </div>
        </div>
