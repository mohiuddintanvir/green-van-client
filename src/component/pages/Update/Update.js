...
const Update = () => {
    ...
    const handleUpdateuser = event => {
        ...
        console.log(users)
        fetch(`https://green-ven-server.vercel.app/orders/${storeuser._id}`, {
            method: 'PUT',
            headers: {
            ...
            <div>
                ...
                <form className='mr-20 mt-10 border-teal-400  mb-20 ml-20' onSubmit={handleUpdateuser}>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 p-20 border-teal-500 bg-black '>
                        <input onChange={handleinputchange} name='firstname' type="text" defaultValue={storeuser.customer} placeholder="First name" className="input input-ghost  w-full input-bordered " />
                        ...
                        <input onChange={handleinputchange} name='email' type="text" placeholder="your email" defaultValue={storeuser?.email} className="input input-ghost w-full input-bordered " readOnly />
